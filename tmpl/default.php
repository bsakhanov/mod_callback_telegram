...
<div class="mod_callback_telegram<?php echo $moduleclass_sfx; ?>">
	<form id="mod_callback_telegram_<?php echo $module->id; ?>" class="form-vertical" action="" method="post" enctype="multipart/form-data">
		
		<div class="mod_callback_telegram_alert control-group alert" style="display:none;"></div>
		...
		<div class="controls">
			<button type="submit" class="btn"><?php echo Text::_('MOD_CALLBACK_TELEGRAM_SUBMIT_LABEL'); ?></button>
		</div>
