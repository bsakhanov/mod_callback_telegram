...
<div class="mod_telegram_callback<?php echo $moduleclass_sfx; ?>">
	<form id="mod_telegram_callback_<?php echo $module->id; ?>" class="form-vertical" action="" method="post" enctype="multipart/form-data">
		...
		<div class="controls">
			<button type="submit" class="btn"><?php echo JText::_('MOD_CALLBACK_TELEGRAM_SUBMIT_LABEL'); ?></button>
		</div>
