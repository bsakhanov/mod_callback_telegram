...
<div class="mod_callback_telegram<?php echo $moduleclass_sfx; ?>">
	...
	<div class="mod_callback_telegram_alert uk-form-row uk-alert" style="display:none;"></div>
		...
		<div class="uk-form-row">
			<button type="submit" class="uk-button"><?php echo Text::_('MOD_CALLBACK_TELEGRAM_SUBMIT_LABEL'); ?></button>
		</div>
