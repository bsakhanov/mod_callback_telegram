...
<div class="mod_callback_telegram<?php echo $moduleclass_sfx; ?>">
	<form id="mod_callback_telegram_<?php echo $module->id; ?>" class="uk-form uk-form-stacked" action="" method="post" enctype="multipart/form-data">
		
		<div class="mod_callback_telegram_alert uk-margin uk-alert" style="display:none;"></div>
		...
		<div class="uk-margin">
			<button type="submit" class="uk-button uk-button-default"><?php echo Text::_('MOD_CALLBACK_TELEGRAM_SUBMIT_LABEL'); ?></button>
		</div>
