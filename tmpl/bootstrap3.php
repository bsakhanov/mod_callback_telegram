	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			switch ($fielditem['ftype'])
			{
				...
				case 'checkbox':
					echo
						($showlabels ? '<div class="checkbox">' : ''),
						'<label class="control-label" for="' . $fielditem['fname'] . '">',
		...
		<?php echo ($showlabels ? '<div class="controls">' : ''); ?>
			<button type="submit" class="btn btn-default"><?php echo JText::_('MOD_TELEGRAM_CALLBACK_SUBMIT_LABEL'); ?></button>
